...
= 1.0.1 =
* FIX: styles for input[type="tel"];
* FIX: Customizer controls for social follow block;
* UPD: Default texts for custom header slogan;
* UPD: Default texts for featured content boxes;
* UPD: Translation files;
* UPD: Sanitize featured content output with wp_kses instead of esc_textarea;
* UPD: screenshot.png.

= 1.0.2 =
* ADD: Posts With Featured Content page teamplat;
* UPD: Allow featured content only for static home page;
* FIX: 404 page style;
* FIX: escaping home_url() int template-tags.php;

= 1.0.3 =
* UPD: License information;
* UPD: Improve data sanitize before output;

= 1.0.4 =
* UPD: License information;
* UPD: wp_kses_post instead of sanitize_textarea for featred content in customizer;
* UPD: pagination for custom home page template listing;
